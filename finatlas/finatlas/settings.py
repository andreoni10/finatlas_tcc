"""
Django settings for finatlas project.
...
# Define tipos e valores padrão (se a variável não existir no .env)
...
WSGI_APPLICATION = "finatlas.wsgi.application"
